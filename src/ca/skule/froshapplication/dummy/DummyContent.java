package ca.skule.froshapplication.dummy;
...
public class DummyContent {
	...
	static {
		// Add 3 sample items.
		addItem(new DummyItem("F!rosh Week Tips", FroshW));
		addItem(new DummyItem("Academic Tips", Academic));
		addItem(new DummyItem("Skule Life Tips", SkuleLife));
	}
